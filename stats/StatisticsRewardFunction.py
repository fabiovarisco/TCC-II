...
class StatisticsRewardFunction(ObserverStatistics):
    ...
    """docstring for StatisticsRewardFunction."""
    def __init__(self, runID, folder, filePrefix = "reward_function"):
        super(StatisticsRewardFunction, self).__init__(runID, folder, ['step', 'tl_id', 'reward_type', 'previous', 'current', 'max', 'reward'], filePrefix)
...
class StatisticsAdaptiveRewardFunctionWeight(ObserverStatistics):
    ...
    def __init__(self, runID, folder, filePrefix = "adaptive_rw_function"):
        super(StatisticsAdaptiveRewardFunctionWeight, self).__init__(runID, folder, ['step', 'tl_id', 'dynamic_weight', 'dynamic_weight_activation', 'reward'], filePrefix)
