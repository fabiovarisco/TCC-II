...
class StatisticsQLearningRewards(ObserverStatistics):
    ...
    def __init__(self, runID, folder, filePrefix = "qlearning_rewards"):
        super(StatisticsQLearningRewards, self).__init__(runID, folder, ['step', 'tl_id', 'previous_state', 'current_state', 'action', 'reward'], filePrefix)
